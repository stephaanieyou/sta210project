...
m4 <- lm(song.hotttnesss ~ artist.familiarity + artist.hotttnesss + song.duration + as.factor(gen_genre) + song.start_of_fade_out
         + song.end_of_fade_in + song.tempo + as.factor(gen_genre)*song.duration, data = music_filter)
...
m4 <- lm(song.hotttnesss ~ artist.familiarity + artist.hotttnesss + song.duration + as.factor(gen_genre) + song.start_of_fade_out
         + song.end_of_fade_in + song.tempo + as.factor(gen_genre)*song.tempo, data = music_filter)
