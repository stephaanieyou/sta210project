...
## Results
By the methodology above, we chose the model with the largest r^2 value -- the second model (**reference m2 above**), with an interaction term of artist familiarity and genre.
